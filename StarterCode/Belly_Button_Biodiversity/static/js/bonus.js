function buildGauge(level) {
    ...
    var data = [{
        ...
        },
        {
            ...
            labels: ['9 washings per week', '8 washings per week', '7 washings per week', '6 washings per week', '5 washings per week', '4 washings per week',
                     '3 washings per week', '2 washings per week', '1 washings per week', 'no washings', ''],
            hoverinfo: 'label',
            hole: .5,
            type: 'pie',
            showlegend: false
